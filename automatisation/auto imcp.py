...
pcap_file = 'icmp1.pcapng'
output_dir = '../Dataset/ICMP'
...
for idx, packet in enumerate(packets):
    if packet.haslayer('ICMP'):
        ...
        img.save(f"{output_dir}/icmp_{idx}.png")

print(f"Images ICMP sauvegardées dans le dossier {output_dir}")
